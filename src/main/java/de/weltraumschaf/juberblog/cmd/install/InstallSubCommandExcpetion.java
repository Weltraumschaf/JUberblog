 ...
 */
public final class InstallSubCommandExcpetion extends Exception {
     ...
     */
    public InstallSubCommandExcpetion(final String message) {
        this(message, null);
    }
     ...
     */
    public InstallSubCommandExcpetion(final String message, final Throwable cause) {
        super(message, cause);
